...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-tree-select', __webpack_require__(3));
    Vue.component('detail-nova-tree-select', __webpack_require__(6));
    Vue.component('form-nova-tree-select', __webpack_require__(9));
});
